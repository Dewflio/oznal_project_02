...
SVM preforms well in high-dimensional spaces, making it suitable for dataset with many features. Also it aims to find best decision boundary, that maximizes margin between classes (reduces overfitting). Performs well by focusing on the most informative features. It can also handle inbalanced datasets, but our classification solves this issue already.
